...
namespace Domain.UnitTests.Pathfinding.Implementation
{
    public class DijkstraTest
    {
        ...
        public void BreadthFirstSearch__should_find_the_shortest_path_horizontal(Grid grid, Position[] expectedShortestPath)
        {
        ...
        public void BreadthFirstSearch__should_find_the_shortest_path_diagonal(Grid grid, Position[] expectedShortestPath)
        {
            var sut = new Dijkstra(grid);
            var pathfindingResult = sut.ShortestPath();
