...
namespace Domain.UnitTests.Entities
{
    public class DiagonalGridTest
    {
        public static IEnumerable<object[]> GetNeighborsDiagonalData()
        {
            ...
            yield return new object[] { grid, grid[0, 1], new Position[] { new(0, 0), new(0, 2), new(1, 0), new(1, 2) } };
            yield return new object[] { grid, grid[0, 2], new Position[] { new(0, 1), new(1, 2) } };

            yield return new object[] { grid, grid[1, 0], new Position[] { new(0, 0), new(0, 1), new(2, 0), new(2, 1) } };
            yield return new object[] { grid, grid[1, 1], new Position[] { new(0, 0), new(0, 1), new(0, 2), new(1, 0), new(1, 2), new(2, 0), new(2, 1), new(2, 2) } };
            yield return new object[] { grid, grid[1, 2], new Position[] { new(0, 1), new(0, 2), new(2, 1), new(2, 2) } };

            yield return new object[] { grid, grid[2, 0], new Position[] { new(1, 0), new(2, 1) } };
            yield return new object[] { grid, grid[2, 1], new Position[] { new(2, 0), new(1, 0), new(1, 2), new(2, 2) } };
